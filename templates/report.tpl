...
<html>
 <head>
    ...
    <title>Criterion.jl report</title>
    <script language="javascript" type="text/javascript" 
	src={{#include}}"{{{dir}}}js/jquery-1.6.4.min.js"{{/include}}>
    </script>
    <script language="javascript" type="text/javascript"
	src={{#include}}"{{{dir}}}js/jquery.flot-0.7.min.js"{{/include}}>
    </script>
    <script language="javascript" type="text/javascript"
	src={{#include}}"{{{dir}}}/js/jquery.criterion.js"{{/include}}>
    </script>
    <style type="text/css">
    {{#include}}{{{css}}}{{/include}}
    </style>
    ...
    <img src={{#include}}"{{{dir}}}/images/julia.png"{{/include}} alt="Julia Logo" width="157" height="106"></img>
    <h1>Criterion.jl performance measurements</h1>
<h2>Overview</h2>
